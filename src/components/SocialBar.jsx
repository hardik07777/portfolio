    ...
    >
      ...
      <div className="flex flex-col items-center gap-6">
        ...
        <a href="https://www.linkedin.com/in/hardik-goel-8ba42b244/" target="_blank" className="group">
          <Linkedin className="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-black dark:group-hover:text-white group-hover:scale-125 transition duration-300" />
        </a>
      </div>
